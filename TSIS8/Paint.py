...
def submaterials():
    ...
    pygame.draw.aaline(buttons_bar, BLACK, (90, 90), (55, 55), 1)  # rect for eraser
...
class Rectangle(GameObject):
    ...
    def draw(self):
        ...
        pygame.draw.rect(SCREEN, self.color, (start_pos_x, start_pos_y, end_pos_x - start_pos_x, end_pos_y - start_pos_y), width=5)
