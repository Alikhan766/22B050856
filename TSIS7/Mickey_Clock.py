...
mickey = pygame.image.load('mickeyclock/mickeyclock.jpg')
right_hand = pygame.image.load('mickeyclock/mickey_right_hand.png')
left_hand = pygame.image.load("mickeyclock/mickey_left_hand.png")

mickey = pygame.transform.scale(mickey, (mickey.get_width(), mickey.get_height()))
